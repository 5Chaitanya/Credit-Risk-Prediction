...
import numpy as np
import joblib
import tflite_runtime.interpreter as tflite  # ⬅ lightweight inference runtime

# Load model & scaler once
@st.cache_resource
def load_model():
    interpreter = tflite.Interpreter(model_path="credit_risk_model.tflite")
...
interpreter, input_details, output_details, scaler = load_model()
